...
public class UIUtils {
	 ...
	 */
	// TODO: Support jump to method
	public static void openMethodInEditor(Project project, CSharpFile file, String methodName) {
...
//	private static PsiElement findMethodBody(CSharpFile file, @NotNull String method) {
//		Ref<PsiElement> result = new Ref<>();
//		file.accept(
//				new OCRecursiveVisitor() {
//					@Override
//					public void visitFunctionDefinition(OCFunctioncwDefinition ocFunctionDefinition) {
