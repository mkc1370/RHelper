...
public final class TaskSettingsComponent extends JPanel {
	...
	private FileSelector sourcePath = null;
	...
	public void setTaskData(TaskData taskData) {
		...
		sourcePath = new FileSelector(
				project,
				taskData.getSourcePath(),
		...
		add(LabeledComponent.create(sourcePath, "Path"));
		...
		UIUtils.mirrorFields(name, sourcePath.getTextField(), TaskData.defaultSourcePathFormat(project));
	}
