...
import name.mkc1370.rhelper.ui.TaskSettingsComponent;
...
/**
 * Run Configuration for running RHelper tasks
 */
public class TaskConfiguration extends RunConfigurationBase {
	...
	public SettingsEditor<? extends RunConfiguration> getConfigurationEditor() {
		return new SettingsEditor<TaskConfiguration>() {
			...
			protected void applyEditorTo(@NotNull TaskConfiguration settings) {
				...
				settings.sourcePath = data.getSourcePath();
	...
	@Override
	public @Nullable CommandLineState getState(@NotNull Executor executor, @NotNull ExecutionEnvironment environment) {
		throw new RHelperException("This method is not expected to be used");
	}
	...
	public TaskConfiguration clone() {
		...
		newConfiguration.sourcePath = sourcePath;
