...
import name.mkc1370.rhelper.generation.CodeGenerationUtils;
...
public class TaskRunner implements ProgramRunner<RunnerSettings> {
	...
	public String getRunnerId() {
		return "name.mkc1370.rhelper.configuration.TaskRunner";
	}
	...
	private static void generateRunFileForTask(Project project, TaskConfiguration taskConfiguration) {
		String pathToClassFile = taskConfiguration.getSourcePath();
